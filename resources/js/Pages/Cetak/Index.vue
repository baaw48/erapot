    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="font-black text-xl text-slate-800 leading-tight tracking-tight">Cetak Dokumen Rapor</h2>
        ...
        <div class="animate-fade-in space-y-6">
            ...
            <div v-else class="bg-white border border-slate-100 rounded-3xl overflow-hidden shadow-[0_4px_24px_rgba(0,0,0,0.02)] relative animate-slide-up" style="animation-delay: 0.05s; animation-fill-mode: both;">
                <!-- Dekorasi -->
                ...
                <div class="relative z-10">
                    <div class="px-8 py-6 border-b border-slate-100 bg-white/50 backdrop-blur-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div>
                            <h3 class="text-lg font-black text-slate-800">Daftar Kelas</h3>
                            <p class="text-sm font-semibold text-slate-500 mt-1">Pilih kelas yang ingin dicetak rapor atau leger-nya.</p>
                        </div>
                        <div class="px-4 py-2 bg-brand-50 border border-brand-100 rounded-xl inline-flex flex-col">
                                ...
                                <tr v-for="(k, index) in kelas" :key="k.id" class="hover:bg-slate-50/50 transition-colors group">
                                    ...
                                    <td class="px-8 py-5">
                                        <div class="flex items-center gap-4">
                                            <div class="h-10 w-10 rounded-xl bg-brand-100 text-brand-600 flex items-center justify-center font-black shadow-inner">
                                                {{ k.tingkat }}
                                            </div>
                                            <div>
