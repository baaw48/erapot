...
<template>
    ...
    <AuthenticatedLayout>
        ...
        <div class="animate-fade-in space-y-8 max-w-6xl mx-auto pb-12">
            ...
            <div class="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border border-slate-200 dark:border-slate-700 rounded-3xl overflow-hidden shadow-[0_4px_24px_rgba(0,0,0,0.02)] relative animate-slide-up" style="animation-delay: 0.05s; animation-fill-mode: both;">
                <div class="absolute -right-20 -top-20 w-64 h-64 bg-brand-50 dark:bg-brand-900/20 rounded-full blur-3xl opacity-50 pointer-events-none"></div>
                <div class="px-8 py-6 border-b border-slate-100 dark:border-slate-700/50 bg-white/50 dark:bg-slate-800/30 backdrop-blur-sm relative z-10 flex items-center gap-3">
                ...
                <form @submit.prevent="submit" class="p-8 relative z-10 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="md:col-span-2 space-y-2 p-6 bg-brand-50 dark:bg-brand-900/20 border border-brand-100 dark:border-brand-800/50 rounded-2xl">
            ...
            <div id="form-ta" class="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border border-slate-200 dark:border-slate-700 rounded-3xl overflow-hidden shadow-[0_4px_24px_rgba(0,0,0,0.02)] relative animate-slide-up" style="animation-delay: 0.2s; animation-fill-mode: both;">
                <div class="px-8 py-6 border-b border-slate-100 dark:border-slate-700/50 bg-white/50 dark:bg-slate-800/30 flex items-center gap-3">
                    <div class="h-10 w-10 rounded-xl bg-purple-100 dark:bg-purple-900/50 text-purple-600 dark:text-purple-400 flex items-center justify-center">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-start">
                            ...
                            <div class="md:col-span-3 space-y-2 flex flex-col justify-end h-full mt-2 md:mt-0">
                                <div class="flex gap-2 w-full h-[42px] mt-6">
                                    ...
                                    <button v-if="isEditingTa" type="button" @click="cancelEditTa" class="px-4 bg-white dark:bg-slate-700 border border-slate-300 dark:border-slate-600 hover:bg-slate-100 dark:hover:bg-slate-600 text-slate-700 dark:text-slate-200 text-xs font-bold rounded-xl transition-colors">
                                        Batal
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="hidden md:block overflow-x-auto border border-slate-200 dark:border-slate-700 rounded-2xl">
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody class="divide-y divide-slate-50 dark:divide-slate-700">
                                <tr v-for="(ta, index) in tahunAjarans" :key="ta.id" class="transition-colors group" :class="{'bg-emerald-50/30 dark:bg-emerald-900/10': ta.is_active, 'hover:bg-slate-50 dark:hover:bg-slate-800/50': !ta.is_active}">
            ...
            <!-- Pengaturan Rapor -->
            <div class="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl border border-slate-200 dark:border-slate-700 rounded-3xl overflow-hidden shadow-[0_4px_24px_rgba(0,0,0,0.02)] p-8">
                <div class="flex items-center gap-3 mb-6">
                    <div class="h-10 w-10 rounded-xl bg-amber-100 dark:bg-amber-900/50 text-amber-600 dark:text-amber-400 flex items-center justify-center">
                ...
                <form @submit.prevent="submitRapor" class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:col-span-2 pt-4 border-t border-slate-100 dark:border-slate-700/50 flex justify-end">
