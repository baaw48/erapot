    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="font-black text-xl text-slate-800 leading-tight tracking-tight">Arsip Rapor</h2>
        ...
        <div class="animate-fade-in space-y-6 pb-12">
            ...
            <div class="bg-white border border-slate-100 rounded-3xl overflow-hidden shadow-[0_4px_24px_rgba(0,0,0,0.02)] relative animate-slide-up" style="animation-delay: 0.05s; animation-fill-mode: both;">
                ...
                <div class="px-8 py-6 border-b border-slate-100 bg-white/50 backdrop-blur-sm relative z-10">
                    <div class="flex items-center gap-3 mb-1">
                        ...
                        <h3 class="text-base font-black text-slate-800">Pilih Tahun Ajaran</h3>
                    </div>
                        ...
                        <button
                            ...
                            :class="[
                                ...
                                selectedTahunId == tahun.id
                                    ...
                                    : 'border-slate-100 bg-slate-50 hover:border-amber-200 hover:bg-amber-50/50 hover:-translate-y-0.5'
                            ]"
                        >
                            <div v-if="tahun.is_active" class="absolute top-3 right-3">
                                <span class="inline-flex items-center gap-1 px-2 py-0.5 bg-emerald-100 text-emerald-700 text-[9px] font-black uppercase tracking-widest rounded-full border border-emerald-200">
                            ...
                            <p :class="['font-black text-base', selectedTahunId == tahun.id ? 'text-amber-700' : 'text-slate-800']">{{ tahun.tahun }}</p>
            ...
            <Transition enter-active-class="transition-all duration-300 ease-out" enter-from-class="opacity-0 translate-y-4" enter-to-class="opacity-100 translate-y-0">
                <div v-if="selectedTahunId" class="bg-white border border-slate-100 rounded-3xl overflow-hidden shadow-[0_4px_24px_rgba(0,0,0,0.02)] relative">
                    <div class="absolute -left-20 -bottom-20 w-64 h-64 bg-emerald-50 rounded-full blur-3xl opacity-50 pointer-events-none"></div>
                    ...
                    <div class="px-8 py-6 border-b border-slate-100 bg-white/50 backdrop-blur-sm relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
                        <div>
                            <div class="flex items-center gap-3 mb-1">
                                ...
                                <h3 class="text-base font-black text-slate-800">Pilih Kelas & Cetak Dokumen</h3>
                            </div>
                    ...
                    <div class="overflow-x-auto relative z-10">
                        <table class="w-full text-left border-collapse">
                            ...
                            <tbody class="divide-y divide-slate-50">
                                <tr v-for="(k, index) in kelas" :key="k.id" class="hover:bg-slate-50/50 transition-colors group">
                                    ...
                                    <td class="px-8 py-5">
                                        <div class="flex items-center justify-center gap-3">
                                            <a
                                                :href="urlLeger(k.id)"
                                                target="_blank"
                                                class="inline-flex items-center gap-2 rounded-xl bg-emerald-50 text-emerald-700 hover:bg-emerald-600 hover:text-white px-4 py-2.5 text-xs font-bold tracking-widest transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/30 hover:-translate-y-0.5 border border-emerald-200 hover:border-emerald-600"
                                            >
            ...
            <div v-if="!selectedTahunId" class="bg-slate-50 border-2 border-dashed border-slate-200 rounded-3xl p-16 text-center animate-slide-up" style="animation-delay: 0.1s; animation-fill-mode: both;">
