    ...
    <AuthenticatedLayout>
        <template #header>
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h2 class="font-black text-xl text-slate-800 leading-tight tracking-tight">Manajemen Admin</h2>
        ...
        <div class="animate-fade-in space-y-6 max-w-[90rem] mx-auto pb-12">
            ...
            <div class="bg-white border border-slate-100 rounded-3xl overflow-hidden shadow-[0_4px_24px_rgba(0,0,0,0.02)] relative animate-slide-up" style="animation-delay: 0.05s; animation-fill-mode: both;">
                ...
                <div class="overflow-x-auto relative z-10">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-slate-50">
                            <tr v-for="(admin, index) in admins.data" :key="admin.id" class="hover:bg-slate-50/50 transition-colors group">
                ...
                <!-- Paginasi -->
                <div class="px-8 py-4 border-t border-slate-100 bg-slate-50" v-if="admins.links && admins.links.length > 3">
        ...
        <Modal :show="showModal" @close="closeModal" maxWidth="md">
            <div class="p-8 relative overflow-hidden">
                ...
                <div class="flex items-center gap-4 mb-8 relative z-10">
                    ...
                    <div>
                        <h2 class="text-xl font-black text-slate-800">{{ isEditing ? 'Edit Data Admin' : 'Tambah Admin Baru' }}</h2>
                ...
                <form @submit.prevent="submit" class="space-y-6 relative z-10">
                    ...
                    <div class="space-y-2">
                        ...
                        <input id="password" v-model="form.password" type="password" class="w-full bg-slate-50 border border-slate-200 text-slate-800 rounded-2xl px-4 py-3 font-bold focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 transition-all placeholder:font-normal placeholder:text-slate-400" :required="!isEditing" placeholder="Minimal 8 karakter" />
