        ...
        <div class="w-full max-w-[28rem] px-6 relative z-10">
            ...
            <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-xl border border-slate-200/50 p-10 relative overflow-hidden">
                ...
                <div class="text-center mb-8">
                    ...
                    <p class="text-sm text-slate-500">Masuk ke Sistem E-Rapot</p>
                </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input
                                id="username"
                                type="text"
                                class="block w-full bg-slate-50 border border-slate-200 text-slate-800 rounded-xl pl-11 pr-4 py-3 font-medium focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 transition-all placeholder:font-normal placeholder:text-slate-400"
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input
                                ...
                                class="block w-full bg-slate-50 border border-slate-200 text-slate-800 rounded-xl pl-11 pr-12 py-3 font-medium focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 transition-all placeholder:font-normal placeholder:text-slate-400"
                            ...
                            <button
                                ...
                                class="absolute inset-y-0 right-0 pr-4 flex items-center text-slate-400 hover:text-primary-500 transition-colors"
                            >
